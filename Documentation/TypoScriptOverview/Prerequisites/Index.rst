...
content elements will not be elaborated on here. We also assume that
you know that the content of a page is put together by a combination
of various content elements. Just to make sure, we point out the fact
that these content elements are stored in the table tt\_content. The
...
that the PID (Page ID) stands for the ID of a page while the UID
(Unique ID) stands for a unique record.
