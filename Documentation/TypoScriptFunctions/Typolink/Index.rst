...
Please resist the urge to a straight :code:`<a href="...">...</a>` construct
in your templates.

Basically :code:`typolink` links the specified text according to
...
:code:`typolink`, in a way, almost works like a wrap: the content which is
defined for example by the :code:`value` property, will be wrapped by the HTML anchor tag.
...
:code:`parameter` property can take a series of values separated
by a white space:
...
The exact syntax for :code:`parameter` property is fully described,
